...
class SignUpPageI extends StatefulWidget {
  const SignUpPageI({Key? key}) : super(key: key);

  @override
  _SignUpPageIState createState() => _SignUpPageIState();
}

class _SignUpPageIState extends State<SignUpPageI> {
  ...
  final DatabaseReference _recruiterDatabaseRef = FirebaseDatabase.instance.ref('interviewers');
    ...
    try {
      ...
      if (user != null) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => LoginPageI()),
        );
      }
    } catch (e) {
